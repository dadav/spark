...
# Find all batteries.
find_batteries() {
  # find2array: https://stackoverflow.com/questions/23356779/how-can-i-store-find-command-result-as-arrays-in-bash
  batteries=()
  while IFS=  read -r -d $'\0'; do
    batteries+=("$REPLY")
  done < <(find /sys/class/power_supply -name 'BAT*' -print0)
